...
class users(models.Model):
    ...
    user_profile_pic = models.ImageField(upload_to="", default=None, null=True)
...
class send_text_to_owner(models.Model):
    ...
    request_user_time = models.DateTimeField(default=timezone.now())
    ...
    reciever_seen = models.BooleanField(default=False)
...
class users_credentials_IPs(models.Model):
    ...
    user_token = models.CharField(max_length=100, default=None, null=True)

    def __str__(self):
        return self.user_email_id


class users_credentials_app_token(models.Model):
    user_id = models.ForeignKey(users, on_delete=models.CASCADE, default=0)
    user_email_id = models.CharField(max_length=50)
    user_ip_address = models.CharField(max_length=100, default=None, null=True)
...
class failure_response(models.Model):
    ...
    failure_user_details = models.ForeignKey(
        users, default="None", on_delete=models.CASCADE
    )
    created_At = models.DateTimeField(
        default=timezone.now(),
        null=True,
...
class super_Admin_users(models.Model):
    ...
    last_login_time = models.DateTimeField(default=timezone.now(), null=True)
    user_ip_address = models.CharField(max_length=100, default=None, null=True)
