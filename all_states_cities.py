...
state_names = {
    ...
    "Gujarat": [
        ...
        "Patdi",
        "Petlad",
        "Petrochemical Comple,x" "Porbandar",
        "Prantij",
        "Radhanpur",
        "Raiya",
        "Rajkot",
    ...
    "Jharkhand": [
        ...
        "Manoharpur",
        "Marma",
        "Meghahatuburu Forest village," "Mera",
        "Meru",
        "Mihijam",
        "Mugma",
        "Muri",
...
def search_for_citites(request, stateName):
    for x in state_names.keys():
        if str(x) == str(stateName):
            data = state_names[x]
